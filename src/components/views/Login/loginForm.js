...
class LoginForm extends Component{
    ...
    state ={
        type:'Login',
        action:'Login',
        actionMode:'Nat a user, Register',
        hasErrors:false,
        form:{
            email:{
                value:"",
    ...
    changeFormType=()=>{
        const type =this.state.type;
         this.setState({
             ...
             actionMode:type==='Login'?'Not Register, Login':'Nat a user, Register',
         })   
    }
    ...
    formHasErrors=()=>(
      ...
      <Text style={styles.errorLabel}>Opps, check your info</Text></View>  
      :null
    )
        ...
        return(
            <View style={styles.formInputContainer}>
                ...
                <View style={
                    ...
                    color ="#fd9727" 
                    onPress={this.submitUser}></Button>
                </View>
                <View style={
                    this.props.platform==="android "
                    ?styles.buttonStyleAndroid
                    ...
                    color ="lightgrey"
                    onPress={this.changeFormType}></Button>
                </View>
                <View>
                    <Button title ="I'll do it later"
                    color ="lightgrey"
                    onPress={()=> LoadTabs(false)}></Button>
                </View>
